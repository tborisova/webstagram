    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-details .s-desc{ font-family: Georgia; font-style: italic; margin-top:5px;width:100%;} ' +
                    ...
                    case "twitter":
                        {
                            ...
                            cardHTML = function (profileData) {
                                ...
                                return '<div class="s-card s-card-pad">' +
                                                        ...
                                                        (profileData.description ? ('<div class="s-desc">' + profileData.description + '<div>') : '') +
                    ...
                    case "facebook":
                        {
                            ...
                            cardHTML = function (profileData) {
                                return '<div class="s-card s-card-pad">' +
                                        ...
                                        (profileData.description ? ('<div class="s-desc">' + profileData.description + '</div>') : '') +
                                        (profileData.start_time ? ('<div class="s-desc"><span class="s-strong">Start Time:</span><br/>' + profileData.start_time + '</div>') : '') +
                                        (profileData.end_time ? ('<div class="s-desc"><span class="s-strong">End Time:<br/>' + profileData.end_time + '</div>') : '') +
                                        (profileData.founded ? ('<div class="s-desc"><span class="s-strong">Founded:</span><br/>' + profileData.founded + '</div>') : '') +
                                        (profileData.mission ? ('<div class="s-desc"><span class="s-strong">Mission:</span><br/>' + profileData.mission + '</div>') : '') +
                                        (profileData.company_overview ? ('<div class="s-desc"><span class="s-strong">Overview:</span><br/>' + profileData.company_overview + '</div>') : '') +
                                        (profileData.products ? ('<div class="s-desc"><span class="s-strong">Products:</span><br/>' + profileData.products + '</div>') : '') +
                                        (profileData.website ? ('<div class="s-desc"><span class="s-strong">Web:</span><br/><a href="' + profileData.website + '">' + profileData.website + '</a></div>') : '') +
                                        (profileData.email ? ('<div class="s-desc"><span class="s-strong">Email:</span><br/><a href="' + profileData.email + '">' + profileData.email + '</a></div>') : '') +
                                        '</div>';
                            };
                ...
                if ($.isEmptyObject(customCardJSON)) {
                    $.ajax({
                        ...
                        beforeSend: function () {
                            ...
                            curHCDetails.append('<div class="s-message">' + loadingHTML + '</div>');
                        },
