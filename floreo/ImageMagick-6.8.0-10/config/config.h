...
#define PACKAGE_STRING "ImageMagick 6.8.0-10"
...
#define PACKAGE_VERSION "6.8.0-10"
...
#define SHARE_PATH "/usr/local/share/ImageMagick-6.8.0/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define SHARE_RELATIVE_PATH "ImageMagick-6.8.0"
